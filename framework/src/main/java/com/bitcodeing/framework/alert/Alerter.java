...
public final class Alerter {
     ...
     * Set the Alert's Icon
     *
     * @param icon The Drawable's Resource Idw
     * @return This Alerter
     */
    public Alerter setIcon(final Drawable icon) {
        if (getAlert() != null) {
            getAlert().setIcon(icon);
        }
    ...
    public Alerter setFilter(boolean filter,int color){
        if (getAlert() != null){
            getAlert().setFilterTint(filter,color);
        }
        return this;
    }

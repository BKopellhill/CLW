package com.bitcodeing.framework.alert;
...
import com.bitcodeing.framework.intefaces.OnShowAlertListener;
...
public class Alert extends FrameLayout implements View.OnClickListener, Animation.AnimationListener {
    ...
    private boolean enableTint = true;
    private int tintColor = android.R.color.white;
    ...
    public ImageView getIcon() {
        if (enableTint)
            ivIcon.setColorFilter(ContextCompat.getColor(getContext(),tintColor));
        return ivIcon;
    }
     ...
     * Set the inline icon for the Alert
     *
     * @param icon Drawable resource id of the icon to use in the Alert
     */
    public void setIcon(final Drawable icon) {
        ivIcon.setImageDrawable(icon);
        CommonLogger.log("dadadadada","valor del filter"+enableTint, LogType.WARNING);
        if (enableTint)
            ivIcon.setColorFilter(ContextCompat.getColor(getContext(),tintColor));
    }
    ...
    /**
     * Set color tint color
     *
     * @param filter True set color icon, false otherwise
     * @param color Color tint to apply
     */
    public void setFilterTint(final boolean filter,final int color){
        this.enableTint = filter;
